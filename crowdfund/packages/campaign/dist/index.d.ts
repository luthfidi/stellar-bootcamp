...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CAHWJK26JM6OMZVXHED76NDKL7PJ7FH3EVFSDT54FENZVF2ERN6WLDRK";
    };
};
...
export interface Client {
     ...
     */
    initialize: ({ owner, title, description, goal, deadline, category, xlm_token }: {
        owner: string;
        title: string;
        description: string;
        goal: i128;
     ...
     */
    get_donation_history: ({ limit, offset }: {
        limit: u32;
        offset: u32;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_metadata: (json: string) => AssembledTransaction<CampaignMetadata>;
        get_donation_history: (json: string) => AssembledTransaction<DonationRecord[]>;
